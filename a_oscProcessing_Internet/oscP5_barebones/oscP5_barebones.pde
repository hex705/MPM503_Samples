...
void mouseReleased() {
  ...
  OscMessage myOutGoingMessage = new OscMessage("/main");  // starts with an ADDRESS PATTERN --> = / + any string you like
  
  // send myBallColor
  myOutGoingMessage.add( 10  );   // 0
  myOutGoingMessage.add( 20.5 );   // 1                              // add an int to the osc message
  myOutGoingMessage.add( "main string ");   // 2
...
void oscEvent( OscMessage theOscMessage ) {
  ...
  println("*** main received an osc message.");
